...
// Main Component
export default function Sutra2() {
    ...
    return (
       <div className="min-h-screen bg-[#f5e5c7] text-stone-800 p-6 sm:p-12 font-serif relative overflow-hidden bg-background2 bg-cover bg-fixed bg-center">
...
<section className="text-center my-8"> <h1 className="text-4xl sm:text-6xl font-bold text-amber-800"> {t("sutra2_title")} </h1> </section>
